...
<head>
    ...
    <script language="JavaScript" src="<?php echo base_url('assets');?>/datatables/jquery.dataTables.min.js" type="text/javascript"></script>
    <script language="JavaScript" src="<?php echo base_url('assets');?>/datatables/dataTables.bootstrap.js" type="text/javascript"></script>
    <!-- Bootstrap core CSS     -->
    ...
    <link rel="stylesheet" type="text/css" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets');?>/css/dataTables.bootstrap.css" rel="stylesheet">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Artikel Kesehatan</h4>
                            </div>
                            <div class="content">
